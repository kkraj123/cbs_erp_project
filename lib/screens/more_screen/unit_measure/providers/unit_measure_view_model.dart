...
StateNotifierProvider<UnitMeasureViewModel, ApiState<UnitMeasureResponseModel>>((ref) {
  return UnitMeasureViewModel(unitMeasureRepo: ref.watch(unitMeasureProvider));
});
