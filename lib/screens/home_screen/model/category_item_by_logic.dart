class CategoryItemsByLogic {
  bool? success;
  int? code;
  String? msg;
  List<CategoryItem>? data;

  CategoryItemsByLogic({
    this.success,
    this.code,
    this.msg,
    this.data,
  ...
  CategoryItemsByLogic.fromJson(Map<String, dynamic> json) {
...
class CategoryItem {
  ...
  CategoryItem.fromJson(Map<String, dynamic> json) {
    ...
    depRate = json['dep_rate']?.toDouble();
    ...
    if (json['children'] != null) {
      ...
      json['children'].forEach((v) {
        children!.add(CategoryItem.fromJson(v));
      });
    }
